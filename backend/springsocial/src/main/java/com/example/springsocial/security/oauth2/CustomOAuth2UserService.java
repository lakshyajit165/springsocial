...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        // set name as first part of email if email is not available from oauth provider
        user.setName(
                oAuth2UserInfo.getName() != null ||
                        StringUtils.hasLength(oAuth2UserInfo.getName()) ?
                            oAuth2UserInfo.getName() : stripNameFromEmail(oAuth2UserInfo.getEmail()));
    ...
    private String stripNameFromEmail(String email) {
        return (email != null && !email.isBlank() && !email.isEmpty()) ? email.split("@")[0] : null;
    }
